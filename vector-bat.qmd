...
### Histoplasmosis
Histoplasma capsulatum is a fungal pathogen that is often transmitted to humans 
...
#| echo: false
#| label: Bat_capture
#| fig-cap: "Left: Bat caught in mist net; Right: Harp trap. 
#| Photo credit (harp trap): Rob and Stephanie Levy, cc-by-2.0."


library(magick)
p1 <- cowplot::ggdraw() + cowplot::draw_image("assets/cover.jpg", scale = 0.9)
p2 <- cowplot::ggdraw() + cowplot::draw_image("assets/Bat_HarpTrap.jpg", scale = 0.9)
